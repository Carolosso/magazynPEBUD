...
/**
 * Class SprzetCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class SprzetCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Sprzet::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/sprzet');
        CRUD::setEntityNameStrings('sprzet', 'Sprzęt');
    }
    ...
    protected function setupListOperation()
    {
        ...
        $this->crud->addButtonFromView('top', 'custom_create_sprzet', 'custom_create_sprzet', 'beginning');
        CRUD::column([
            'name' => 'image_url',
            'label' => 'Zdjęcie',
            'type' => 'image',
    ...
    protected function setupCreateOperation()
    {
        ...
        $this->crud->setHeading('Tworzenie nowego Sprzętu','create');
